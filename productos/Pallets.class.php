...
/*
  ---------------------------------------------------------
  | Pallets.class.skel    Skeleton for main clases        |
  |---------------------------------------------------------|
...
class Pallets {
    ...
    private $table = 'pallets';
    private  $items = [array("column_name"=>"nro_pallet","nullable"=>"YES","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Nro Pallet=>","titulo_listado"=>"Nro Pallet","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
    array("column_name"=>"kg","nullable"=>"YES","data_type"=>"decimal","max_length"=>"","numeric_pres"=>"10","dec"=>"2","titulo_campo"=>"Kg=>","titulo_listado"=>"Kg","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>"")];    
    private $primary_key = 'nro_pallet';
    private $limit = 2000;
    ...
    function updateData() {
       ...
       if($my->AffectedRows() > 0){
           ...
           echo json_encode(array("mensaje"=>"Error","query"=>"Ningun registro ha sido modificado"));
       }           
       $my->Close();      
